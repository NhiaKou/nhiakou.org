...
// Reference: https://codepen.io/kitsune/pen/mPLvVp
...
template.innerHTML = `
    ...
    <text text-anchor="middle" x="410" y="260" fill="grey" font-size="25" font-weight="bold">Currently in stealth development...</text>
    </svg>
`;
